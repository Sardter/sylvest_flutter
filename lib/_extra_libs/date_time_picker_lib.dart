...
/// A [DateTimePicker] that contains a [TextFormField].
///
/// This is a convenience widget that wraps a [TextFormField] widget in a
/// [DateTimePicker].
///
...
///
/// ![ If the user enters valid text, the TextFormField appears normally without any
...
///  * [TextFormField], which is the underlying text field without the [Form]
///    integration.
...
class DateTimePicker extends FormField<String> {
  /// Creates a [DateTimePicker] that contains a [TextFormField].
  ///
  ...
  /// and [new TextFormField], the constructor.
  DateTimePicker({
    Key? key,
  ...
  /// [date], [time], [date] or [dateTimeSeparate].
        ...
        return MediaQuery(
          ...
          child: Theme(
            data: Theme.of(context).copyWith(
              ...
              primary: const Color(0xFFe6733c),
            )),
            child: child!,
          ),
        );
