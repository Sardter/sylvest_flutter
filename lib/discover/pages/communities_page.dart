...
class MoreCommunitiesPage extends StatefulWidget {
  const MoreCommunitiesPage({Key? key}) : super(key: key);

  @override
  State<MoreCommunitiesPage> createState() => MoreCommunitiesPageState();
}

class MoreCommunitiesPageState extends State<MoreCommunitiesPage> {
  final _postsKey = GlobalKey<CommunitiesPageState>();

  bool _isRefreshing = false;
  bool _isLoading = false;
  bool _appbarVisible = false;

  late final _postsPage = CommunitiesPage(key: _postsKey,);
